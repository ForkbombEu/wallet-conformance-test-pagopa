...
const publicBaseUrls = buildPublicBaseUrls();
...
function buildPublicBaseUrls(): string[] {
...
function buildOpenApiSpecForRequest(req: Request) {
...
app.get("/openapi.json", (req, res) => {
  res.status(200).json(buildOpenApiSpecForRequest(req));
});
